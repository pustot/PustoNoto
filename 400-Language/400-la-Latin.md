...
- salve(te): hello. `te` when to 多人
- ave(te): more formal greetings
- nomen mihi est Pustus
- how are you: Quid agis? / Quomodo te habes?
- -ne 可以加到是非问句的第一个词后，也可省略。
- num 暗示希望否定回答
    - > Num Romae habitat? Surely he doesn't live in Rome?
- -(i)tas = en.-(i)ty, 3-decl, f.
- Nom. Dat. placeo = N D gefallen

Latin 	|English 	|Additional Info (Declension, gender, etc.)|Stem
-|-|-|-
