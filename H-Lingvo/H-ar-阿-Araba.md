...
- 记f q之区别：加一点表示擦音，f与th dh gh同理；q则像t那样是塞音，两点
...
4 ʾafʿala | 2aXYaZa | 使动 | أَحْدَثَ (ʾaḥdatha)：表示“引发”或“造成”，意思是使某事发生。 | أَكْتَبَ (ʾaktaba) 使某人书写或委托写 |  أَسْلَمَ (ʾaslama) 使和平或归顺，皈依（为什么来自使动的Form4呢，可能因为是主动的在宗教意义上是自己内心进入和平） 📝就是皈依回教对应的动词，islaam muslim 皆源自此 | ع ل م • (ʕ-l-m) 知道、知识 ->   أَعْلَمَ (ʔaʕlama, “to inform”)； ح ب ب (ḥ b b) 膨胀、鼓起、充盈，爱 -> 「 أحب  （/ʔa.ħab.ba/）」爱（例如用于我爱你）（可能延伸自情感膨胀，内心涌动？）
...
基本上，元音uai对应主宾属，xxxun是不定，al xxxu是定，xxxu是construct case

方言省略词尾的格标记

### 构造格（构建状态） construct case

阿拉伯语表示领属关系的结构有所有格结构Iḍāfah （إضافة）iDaafa，这种结构的标志是第一个名词，相当于of前的名词，即便是定的也不带定冠词al，而后面紧跟其他名词，相当于of后的名词，他们带不带al决定了整个结构的定与不定。可以有一系列的词，其中除了最后一个，都处于construct case；除了第一个，都处于属格。唉我感觉就是属格啦，只不过第一个词不带冠词，且非末尾词给了个construct case来等待后续连接

# 代词

## 附加代词

介词后接的代词和动词宾语的代词都要写成附加代词。

# 动词

变形

- 古典阿语或者现代标准阿语的变位比实际常用的各种方言要复杂得多。故学习时可适当放低要求。。。
- 人称
    - 方言的人称省略了双数与阴复，而只剩8个：一二三称单复+阴二单阴三单
- 语态：主动被动
    - 主动态和被动态一般只有短元音的区别，故写法完全一致。（若以阅读优先，偷懒先不记了。。。？）
- 时态：过去和现在
    - 有的人描述为完整体和非完整体。总之就这两个。
- 语气：（陈述）、虚拟、祈使、简接祈使语气（Jussive）
    - 简接祈使语气（Jussive）：用于否定命令、否定过去的动作、条件句等
- 衍生：动名词、主动分词、被动分词
...
- Medina
- Maghreb
- Casablanca - الدَّار الْبَيْضَاء (ad-dār al-bayḍāʔ, “the white house”)
- Al Jazeera
- Islam
- Muslim
- Quran
