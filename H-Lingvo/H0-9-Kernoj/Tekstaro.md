...
- 连句：状语从句（时间、目的、方式）
- 体貌：习惯、突然（瞬时）
- 情绪（高兴、生气、悲伤）和心理状态（担心、害怕、满意）
- 数词（序数词、分数词、倍数表达等）
- 时间（“上午十点半”、“三天后”）
- 方位与距离（“靠近（旁边）、远离、之间、周围”“离我家两公里”）
- 疑问（选择疑问、反问、否定疑问）
- 双重否定（“他没有不去。”）
- 比喻（“她跑得像风一样快。”）等修辞表达
...
ja | 其中汉字是表意文字，假名是表示音节的表音文字且拼读一致，掌握每个单独的假名（即音节）即可拼读所有日文（列出所有假名的表叫五十音图）。唯一的例外是平假名は、へ作为格助词时读wa、e。（这种规律性是因为二战后日本使用了“现代假名遣”，不再使用“历史假名遣”）
de | 拼读很一致：拼写一般对应固定的发音，掌握辅音、元音字母组合辅音元音之配合即可，音节间不连读（即音节首元音前有喉塞音）。
eo | 毕竟人造语言，Esperanto（通称世界语）拼读一致！一字一音，把字母表学一遍即会拼读。重音固定在倒数第二音节。（小提示：清辅音有人会读成不送气，建议不熟练浊音的中国人把清音读成送气。）
ko | 音节之间疯狂连读……韵尾根据单独与连读而表现不同。除此之外倒是与拼写较为一致。
vi | 吾主要看河内音。有一些元音字母组合与单独字母发音不太一样。
fr | 拼读很一致：拼写一般对应固定的发音，掌握辅音、元音字母组合辅音元音之配合即可，但音节间喜欢连读。
es | 拼读很一致，但：浊辅音在一些位置需要弱化（擦化为[β] [ð] [ɣ]，如bdg在元音间，b在辅音后）；s不会像英语一样浊化，但西班牙一些地区发其为[θ]，c+e/i、z约等于s。
ru | 非重音位置的元音要弱化。
ar | 元音音位有 a i u，分别有长短。a 在大多数辅音的环境中实现为 /æ/，包括唇辅音、舌冠音（非咽化的）、声门辅音、k、j、w；在靠后的环境发为 [ɑ] 如咽化辅音、小舌音、咽辅音。记f q之区别：加一点表示擦音，f与th dh gh同理；q则像t那样是塞音，两点。
...
知识点：介词、情态（可以、必须、不许、想要、需要、应该、愿意、可能）、被动态和使动态
