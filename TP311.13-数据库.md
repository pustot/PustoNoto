...
Unterschied davon: `#{}`, womit *using the #{} syntax will cause MyBatis to generate PreparedStatement properties and set the values safely against the PreparedStatement parameters (e.g. ?)*; gegen `${}`, d.h. *String Substitution*.
