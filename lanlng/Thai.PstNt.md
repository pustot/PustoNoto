...
泰语属于侗台语，壮傣语支，壮语、黎语、布依语、傣语、水语、老挝语（寮语）与其有比较近的亲缘关系。可见西南地区的许多少数民族可能会觉得泰语很容易学，比如“同源异流”[[1]](#参考文献)的壮族，其邻国老挝的官方语言老挝语的口语也可以与其互通。

侗台语起源于中国东南部，很多古文献记载的“越人”“吴人”所说的语言都被用来研究侗台语等语言，如郑张尚芳用泰文字尝试转写了《越人歌》等。

不过侗台语的属类问题并无定论，主张其属于汉藏语系者如李方桂，主张其与南岛语系同属于南-台语系者如白保罗，此外还有如郑张尚芳等主张的范围更大的华澳语系[[2]](#参考文献)。这主要是由于各个语言相互接触频繁而深远，因此较难分辨其中哪些是发生学关系，哪些是后天接触产生的关系。
...
泰文字母衍生于婆罗米字母的巴利文这一支。由下图[[3]](#参考文献)可见，许多我们熟悉的文字系统，比如梵文、藏文、缅甸文等皆为一系。
...
为了方便记忆发音，下面给出按发音归类的辅音字母表，并标示国际音标，而不采用泰文字传统的顺序和字母名。截图自维基百科。
...
泰文字的元音用21个附标元素组成，它们有的出现在辅音上方，有的在下方，有的在左方，有的在右方，有的则是这几种情况的结合（比如 เ◌ียะ 表示[iaʔ]，位于辅音的左上右三个位置）。它们单独或组合构成元音，最后形成众多元音。整理如下面三个表。整理自[维基百科][^wiki-th]的信息
...
像很多其他元音附标文字一样，泰文的辅音字母可以不带元音附标，发缺省的元音。开音节（无尾辅音）的缺省值为[a]，闭音节的缺省值为[o]。下面是一些拼写示例（辅音、元音及其对应的字母、附标分别用蓝色、红色表示），音标来自维基词典
...
泰语是声调语言，泰文字可以表示其声调，但调值并不像汉语拼音或国际音标那样易懂，而是由辅音字母的类别（高、中、低）、元音长短、尾辅音（为塞音则成为死音节，为响音则称为活音节）以及声调附标等因素共同确定。具体规则整理如下表，整理自[维基百科][^wiki-th]的信息
...
泰语的数词比较统一地采用十进制（手动艾特法语（`97=4*20+10+7`）、丹麦语（`97=7+(-½+5)*20）`）。0~9的数词中，0来自梵语，1来自其祖宗原始台语，2~9来自古汉语或中古汉语，其中“2”来自汉语“双”，其另一形式来自汉语“二”但用途有别，见下文。下图列出0~10的基数词，来自[维基百科][^wiki-thnum]
...
举“吃”为例，在泰语中有很多个“吃”，用于不同的语域。截图自[维基百科][^wiki-th]。
