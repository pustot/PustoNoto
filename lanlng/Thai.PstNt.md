...
泰语属于侗台语，壮傣语支，壮语、黎语、布依语、傣语、水语、老挝语（寮语）与其有比较近的亲缘关系。可见西南地区的许多少数民族可能会觉得泰语很容易学，比如“同源异流”[^qinshengmin,2003]的壮族，其邻国老挝的官方语言老挝语的口语也可以与其互通。

侗台语起源于中国东南部，很多古文献记载的“越人”“吴人”所说的语言都被用来研究侗台语等语言，如郑张尚芳用泰文字尝试转写了《越人歌》等。

不过侗台语的属类问题并无定论，主张其属于汉藏语系者如李方桂，主张其与南岛语系同属于南-台语系者如白保罗，此外还有如郑张尚芳等主张的范围更大的华澳语系。[^qiwang,2011]这主要是由于各个语言相互接触频繁而深远，因此较难分辨其中哪些是发生学关系，哪些是后天接触产生的关系。
...
广泛采用的泰文字，是元音附标文字，声调亦由附标标示。拼与读的对应关系复杂，原因有以下几点：

1. 文字系统形成后，语音发生过很大变化，如一些辅音读音合并，三声调变化为五声调；
2. 为了在引入梵语、巴利语词时尽量保留源语言的拼写，有一些字母对应梵语、巴利语中区分但泰语中并不区分的音素，读音却按泰语的音系，甚至一些此类字母不发音

泰文写起句子来比较长，相应地字号就调得比较小，略难辨认的，入坑须练好眼力。

## 文字系谱

泰文字母衍生于婆罗米字母的巴利文这一支。由下图[^zhanggongjin,1991]可见，许多我们熟悉的文字系统，比如梵文、藏文、缅甸文等皆为一系。
...
婆罗米字母本身的起源则说法不一[^wiki婆罗米起源]，一些学者认为其起源于印度本土，另一些认为其来自阿拉米字母（于是又是来自于腓尼基字母，并最终源自古埃及象形文字）。

## 辅音符号

表示辅音的符号是辅音字母，有44个，其中两个现代已弃用。在音节首时标示21种音，在音节尾只使用其中36个字母表示8种音，另外短元音后不出现尾辅音字母时要添加一个声门塞音 [ʔ]。

为了方便记忆发音，下面给出按发音归类的辅音字母表，并标示国际音标，而不采用泰文字传统的顺序和字母名。截图自维基百科。[^wiki-th]

![辅音字母在音节首的读音](https://raw.githubusercontent.com/pusto-tauranth/test_1/master/ghruk/lanlng/th/%E8%BE%85%E9%9F%B3%E5%AD%97%E6%AF%8D%E9%9F%B3%E8%8A%82%E9%A6%96.PNG)

![辅音字母在音节尾的读音](https://raw.githubusercontent.com/pusto-tauranth/test_1/master/ghruk/lanlng/th/%E8%BE%85%E9%9F%B3%E5%AD%97%E6%AF%8D%E9%9F%B3%E8%8A%82%E5%B0%BE.PNG)

## 元音符号

泰文字的元音用21个附标元素组成，它们有的出现在辅音上方，有的在下方，有的在左方，有的在右方，有的则是这几种情况的结合（比如 เ◌ียะ 表示[iaʔ]，位于辅音的左上右三个位置）。它们单独或组合构成元音，最后形成众多元音。整理如下面三个表。整理自维基百科的信息[^wiki-th]
...
![额外的元音（整体认读）](https://github.com/pusto-tauranth/test_1/blob/master/ghruk/lanlng/th/%E6%B3%B0%E8%AF%AD%E9%A2%9D%E5%A4%96%E5%85%83%E9%9F%B3%E6%95%B4%E7%90%86.PNG?raw=true)

像很多其他元音附标文字一样，泰文的辅音字母可以不带元音附标，发缺省的元音。开音节（无尾辅音）的缺省值为[a]，闭音节的缺省值为[o]。下面是一些拼写示例（辅音、元音及其对应的字母、附标分别用蓝色、红色表示），音标来自维基词典[^wiktio]
...
泰语是声调语言，泰文字可以表示其声调，但调值并不像汉语拼音或国际音标那样易懂，而是由辅音字母的类别（高、中、低）、元音长短、尾辅音（为塞音则成为死音节，为响音则称为活音节）以及声调附标等因素共同确定。具体规则整理如下表，整理自维基百科的信息[^wiki-th]

![泰文声调表示方法](https://github.com/pusto-tauranth/test_1/blob/master/ghruk/lanlng/th/%E6%B3%B0%E8%AF%AD%E5%A3%B0%E8%B0%83%E7%AC%A6%E5%8F%B7%E6%95%B4%E7%90%86.PNG?raw=true)

其中“无”指不加声调附标。后两个声调附标只用于中辅音。
...
泰文字包括一套十进制的数字系统，与阿拉伯数字对应如下：[^wiki-thnum]

![泰文数字符号](https://github.com/pusto-tauranth/test_1/blob/master/ghruk/lanlng/th/%E6%B3%B0%E6%96%87%E6%95%B0%E5%AD%97.PNG?raw=true)
...
![GBoard without Shift](https://github.com/pusto-tauranth/test_1/blob/master/ghruk/lanlng/th/%E8%BE%93%E5%85%A5%E6%B3%95%E7%AC%AC%E4%B8%80%E9%A1%B5.png?raw=true)

![GBoard with Shift](https://github.com/pusto-tauranth/test_1/blob/master/ghruk/lanlng/th/%E8%BE%93%E5%85%A5%E6%B3%95%E7%AC%AC%E4%BA%8C%E9%A1%B5.png?raw=true)
...
由于泰文字是表音文字，介绍泰文字时也已经提到了泰语语音的许多基本特点。此处再从语音的角度加以总结和补充。
...
泰文字的介绍中，元音已展示得很详细。需要注意的是泰语元音有长短之分。此外，泰语有开的双元音，闭的双元音和三元音。[^wiki-th]
...
前面说过，辅音字母的类别（高、中、低）、元音长短、尾辅音、声调附标、前引字都是声调符号的决定因素。实际声调的区分规则甚至不止笔者前面列出的那些，如需深入学习还要多多理解完整的规则。这里列出泰语的高中低辅音，高辅音——ข ฉ ฐ ถ ผ ฝ ศ ษ ส ห，中辅音——ก จ ด ต ฎ ฏ บ ป อ，低辅音——ค ฆ ง ช ซ ฌ ญ ฑ ฒ ณ ท ธ น พ ฟ ภ ม ย ร ล ว ฬ ฮ。
...
泰语的数词比较统一地采用十进制（手动艾特法语（`97=4*20+10+7`）、丹麦语（`97=7+(-½+5)*20）`）。0~9的数词中，0来自梵语，1来自其祖宗原始台语，2~9来自古汉语或中古汉语，其中“2”来自汉语“双”，其另一形式来自汉语“二”但用途有别，见下文。下图列出0~10的基数词，来自维基百科。[^wiki-thnum]

![泰语基数词0~10](https://github.com/pusto-tauranth/test_1/blob/master/ghruk/lanlng/th/%E6%B3%B0%E8%AF%AD%E5%9F%BA%E6%95%B0%E8%AF%8D09%E6%88%AA%E5%9B%BE.PNG?raw=true)

需要进位时，规则与汉语很近似。其中“十”“万”两个词来自中古汉语。当个位前有其他数字，也就是基数词大于9时，个位的“一”变为 เอ็ด /et/，此词来自汉语。“二十”不是“song sip”而是 yi sip，来自汉语“二十”，其他的数字都较为规则。nueng 不出现在 sip（十）之前，故二百一十是 song roi sip（“双 百 十”），在其他位数可以出现也可以不出现，比如一百是 roi 或者 nueng roi。从十到百万，每一位数字都有自己的名字，也是不容易。百万以上则用十的倍数乘以lan，如千万 sip lan，万亿（10^12）为 lan lan，这部分有些类似汉语的系统。见下图，来自维基百科。

![泰语基数词进位](https://github.com/pusto-tauranth/test_1/blob/master/ghruk/lanlng/th/%E6%B3%B0%E8%AF%AD%E5%9F%BA%E6%95%B0%E8%AF%8D%E8%BF%9B%E4%BD%8D.PNG?raw=true)
...
举“吃”为例，在泰语中有很多个“吃”，用于不同的语域。截图自维基百科。[^wiki-th]

![泰语的 N 种吃法。你喜欢怎么吃？](https://github.com/pusto-tauranth/test_1/blob/master/ghruk/lanlng/th/%E6%B3%B0%E8%AF%AD%E5%A5%BD%E5%87%A0%E4%B8%AA%E5%90%83.PNG?raw=true)

# 词汇

固有词多为单音节词，但也有很多复合词以及外语借词。

泰语词汇在古代就受汉语影响很大，吸收了许多古汉语、中古汉语词汇，后来中国南方人也有很多移居泰国，带去了很多按闽语等方言发音的汉语词汇。这些汉借词对我们学习泰语会有帮助。许多泰语学习网站都提供了有关资源，比如[^hujiang-th-zh]
...
[^qinshengmin,2003]: 覃圣敏.壮泰民族传统文化比较研究[M].桂林:广西人民出版社,2003.ISBN9787219049150.
[^qiwang,2011]: 齐旺.壮侗语与汉语关系研究概况[J].四川民族学院学报,2011,20(06):29-32. 
[^zhanggongjin,1991]: 张公瑾.傣文渊源及其近亲文字[C]//中国民族古文字研究（第三辑）.1991.
[^wiki婆罗米起源]: https://en.wikipedia.org/wiki/Brahmi_script#Origins
...
[^wiki-thnum]: https://en.wikipedia.org/wiki/Thai_numerals
[^wiktio]: https://www.wiktionary.org/
