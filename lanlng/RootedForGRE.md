...
acuity 尖锐,敏锐(acu+ity 性质=尖的性质=尖锐)
...
affidavit n 口供书,宣誓书(af 一再+fid+avit 表名词=一再发誓相信=宣誓书)
...
monogamy n 一夫一妻制(mono 一个+gam+y=结婚一次=一夫一妻制)

bigamy n 重婚罪(bi 二次+gam+y=二次婚=重婚) 
...
dehydrate v 脱水(de 去掉+hydr+ate=去掉水)
...
merchant n 商人(merch+ant 表示人)

merchandise n 商品(merchand[=merchant 商人]+ise=商人的东西=商品)
...
composure n 镇静,沉着(com 一起+pos+ure=[精神]放到一起
...
supposition n 推测,猜想(sup 在下面+posit+ion=放在下面的
...
preoccupation 全神贯注(pre+occup 占有+ation=优先占有(注
...
impress v 盖印,使感动(im 进+press=压进去=盖印=印入头脑
...
prosecute 检举;指控(pro+secu 追随+ate=追随到[法院]前面
...
expugnable a 可克服的,可征服的(ex 出+pugn+able=能打出
...
puritan n 清教徒(讲究道德纯洁之人) purge v 使清净
...
requite v 报答,报应(re 回+quite 自由,释放=回到自由状态=报
...
relinquish 不再采取行动,放弃(re+linqu 离开+ish=离开不再要
...
conscribe v 征募,招募(con 大家+scribe=大家写上[名字]=征
...
consign v 委托,寄存(con 共同+sign=共同做记号=把…委托
...
insinuate v 暗示,巧妙巴结(in 进入+sinu+ate=进入弯曲=不直
...
dissociate v 分离,断绝关系(dis 分开+soci+ate=伙伴分开=分
...
perspective n 看法,眼界,透视(per 全部+spect+ive=全部看到
...
spectacular a 奇妙的,惊人的(spect+acular…的,来自 spectacle
...
spontaneous a 自愿的,自发的(spont+aneous=自[内心]承诺
